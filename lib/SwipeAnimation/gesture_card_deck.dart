...
class GestureCardDeck1 extends StatefulWidget {
  final List data;
  ...
  @override
  GestureCardDeck1State createState() => new GestureCardDeck1State();
}

class GestureCardDeck1State extends State<GestureCardDeck1>
